...
GROUP BY time_of_day 
ORDER BY total_sales DESC;
-- For most of the days of the week, evenings are the time of day when most sales made
-- For Wednesday and Friday, afternoons are the time of day when most sales made
...
GROUP BY gender
ORDER BY gender_cnt DESC;
-- Branches A and B have more male customers, whereas branch C has more female customers than male customers
